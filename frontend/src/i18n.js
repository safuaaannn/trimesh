...
export const translations = {
  en: {
    ...
    reset: "Reset",
    normalizeAPose: "Normalize A-pose",
    selectPerson: "Select Person",
    person: "Person",
    thetaControl: "MHR Theta Scale",
    rawPoseTitle: "Advanced: Raw MHR Pose",
    rawPoseHint: "Paste 130 comma/space-separated pose values (radians).",
    rawPoseLoad: "Load Current",
    rawPoseInsertZeros: "Insert {count} Zeros",
    rawPoseClean: "Clean & Trim",
    rawPoseApply: "Apply Pose",
    rawPoseCount: "Values",
    rawPoseMissing: "Missing",
    rawPoseExtra: "Extra",
    rawPosePositions: "positions",
    rawPoseTemplateHint: "Need exactly {count} numbers ({joints} joints × 5). Start with Load Current or Insert {count} Zeros.",
    rawPoseTemplateHintSimple: "Need exactly {count} numbers. Start with Load Current or Insert {count} Zeros.",
    rawPoseAutoFixHint: "Apply Pose auto-fixes: removes non-numbers, trims extra, fills missing with current pose values.",
    rawPoseEditorTitle: "Per-joint editor",
    rawPoseSelectJoint: "Joint",
    rawPoseUpdateJoint: "Update Joint",
  ...
  zh: {
    ...
    poseControls: "姿态控制",
    reset: "重置",
    normalizeAPose: "标准 A 姿态",
    selectPerson: "选择人物",
    person: "人物",
    thetaControl: "MHR Theta 缩放",
    rawPoseTitle: "高级：MHR 原始姿态",
    rawPoseHint: "粘贴 130 个逗号/空格分隔的姿态值（弧度）。",
    rawPoseLoad: "加载当前值",
    rawPoseInsertZeros: "填充 {count} 个 0",
    rawPoseClean: "清理并裁剪",
    rawPoseApply: "应用姿态",
    rawPoseCount: "数值",
    rawPoseMissing: "缺少",
    rawPoseExtra: "多余",
    rawPosePositions: "位置",
    rawPoseTemplateHint: "必须是 {count} 个数字（{joints} 个关节 × 5）。可先加载当前值或填充 {count} 个 0。",
    rawPoseTemplateHintSimple: "必须是 {count} 个数字。可先加载当前值或填充 {count} 个 0。",
    rawPoseAutoFixHint: "应用姿态会自动修复：移除非数字、裁剪多余、缺失项用当前姿态补齐。",
    rawPoseEditorTitle: "按关节编辑",
    rawPoseSelectJoint: "关节",
    rawPoseUpdateJoint: "更新关节",
